              ...
              child: Row(
                ...
                children: [
                  Icon(
                    ...
                    color: autoPlay ? _AppColors.primaryLight : Colors.white54,
                    size: 14,
                  ),
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => AnimatedContainer(
              ...
              child: Icon(
                ...
                color: active ? _AppColors.primaryLight : Colors.white24,
                size: 11,
              ),
            ),
          ),
        ...
        children: [
              ...
              children: [
                ...
                AnimatedBuilder(
                  ...
                  builder: (_, __) => Container(
                    ...
                    height: 7,
                    decoration: BoxDecoration(
                      color: isOnline ? _AppColors.success : Colors.white24,
                      shape: BoxShape.circle,
                      boxShadow: isOnline
                          ? [
                              BoxShadow(
          ...
          Expanded(
            child: ClipRRect(
              ...
              child: Stack(
                children: [
                  Positioned.fill(child: _buildMock(phase)),
                  // Description overlay
                  Positioned(
                    left: 0,
                    right: 0,
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [bg.withOpacity(0), bg.withOpacity(0.96), bg],
  ...
  Widget _buildMock(_Phase p) {
    if (isPassenger) {
      ...
      switch (p) {
        ...
        case _Phase.arrived:
          return _DMockNav(pulse: pulse, driverMove: driverMove, arrived: true);
        case _Phase.inTrip:
          return _DMockTrip(
            pulse: pulse,
            driverMove: driverMove,
...
class _MapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final roadPaint = Paint()..color = Colors.white.withOpacity(0.88);
    ...
    final buildingPaint = Paint()..color = Colors.blueGrey.withOpacity(0.18);

    // Major roads
    canvas.drawRect(
      Rect.fromLTWH(0, size.height * 0.38, size.width, 5),
      roadPaint,
    );
    canvas.drawRect(
      Rect.fromLTWH(0, size.height * 0.68, size.width, 6),
      roadPaint,
    );
    canvas.drawRect(
      Rect.fromLTWH(size.width * 0.42, 0, 5, size.height),
      roadPaint,
    );
    canvas.drawRect(
      Rect.fromLTWH(size.width * 0.72, 0, 6, size.height),
      roadPaint,
    );
    // Minor roads
    canvas.drawLine(
        ...
        children: [
          ...
          Transform.translate(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  const Icon(Icons.search, color: _AppColors.primary, size: 12),
                  const SizedBox(width: 5),
                  Expanded(
                    child: Text(
                      searching
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: highlighted ? color.withOpacity(0.4) : _AppColors.border,
      ...
      child: Row(
        children: [
          ...
          Icon(Icons.chevron_right, color: _AppColors.textTertiary, size: 11),
        ],
      ),
    );
  }
                ...
                children: [
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (_, __) => Positioned(
                      top: arrived ? 20 : 20 + 28 * (1 - driverMove.value),
                      left: arrived ? 27 : 27 + 16 * (1 - driverMove.value),
                      child: Container(
                        width: 20,
                        height: 20,
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: _AppColors.amber.withOpacity(0.45),
                              blurRadius: 8,
                            ),
                          ],
                        ),
                    ...
                    builder: (_, __) => Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: _AppColors.amber.withOpacity(0.4),
                              blurRadius: 7,
                            ),
                          ],
                        ),
...
class _FareRow extends StatelessWidget {
  ...
  const _FareRow({required this.label, required this.value, this.bold = false});
        ...
        children: [
          Expanded(
            child: Text(
              ...
              style: TextStyle(
                fontSize: 8,
                color: bold ? _AppColors.textPrimary : _AppColors.textTertiary,
          ...
          Text(
            ...
            style: TextStyle(
              fontSize: 8,
              color: bold ? _AppColors.primary : _AppColors.textSecondary,
        ...
        children: [
          ...
          AnimatedBuilder(
            ...
            builder: (_, __) => Container(
              ...
              decoration: BoxDecoration(
                color: _AppColors.success.withOpacity(
                  0.08 + 0.05 * pulse.value,
                ),
                borderRadius: BorderRadius.circular(10),
                border: Border.all(
                  color: _AppColors.success.withOpacity(
                    0.25 + 0.2 * pulse.value,
                  ),
                ),
              ),
              child: Row(
            ...
            children: [
              Expanded(
                child: Container(
                  height: 30,
                  decoration: BoxDecoration(
                    border: Border.all(color: _AppColors.error),
                    borderRadius: BorderRadius.circular(7),
                  ),
                  child: const Center(
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Icon(Icons.close, color: _AppColors.error, size: 11),
                        SizedBox(width: 3),
                        Text(
                          'Decline',
                          style: TextStyle(
            ...
            child: Column(
              children: [
                ...
                AnimatedContainer(
                  ...
                  height: 28,
                  decoration: BoxDecoration(
                    color: arrived ? _AppColors.success : _AppColors.primary,
                    borderRadius: BorderRadius.circular(7),
                  ),
                  child: Center(
                    child: Text(
              ...
              children: [
                ...
                const Row(
                  children: [
                    ...
                    Icon(Icons.star_rounded, color: _AppColors.amber, size: 9),
                    Text(
                      '4.9',
                      style: TextStyle(color: Colors.white38, fontSize: 7),
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: isToday
                                ? _AppColors.driverAccent
                                : _AppColors.primary.withOpacity(0.42),
...
class _OutlineBtn extends StatelessWidget {
  ...
  const _OutlineBtn({required this.label, this.icon, this.height = 30});
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Icon(Icons.two_wheeler, color: Colors.white, size: 16),
                        SizedBox(width: 7),
                        Text(
                          'Try Driver',
                          style: TextStyle(
