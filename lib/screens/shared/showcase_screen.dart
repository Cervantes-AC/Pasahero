  ...
  Widget _buildMock(_Phase p, AnimationController pulse) {
    if (isPassenger) {
      switch (p) {
        ...
        case _Phase.enRoute:
          return _PMockTracking(pulse: pulse, arrived: false);
        case _Phase.arrived:
          return _PMockTracking(pulse: pulse, arrived: true);
        case _Phase.inTrip:
      ...
      switch (p) {
        ...
        case _Phase.accepted:
        case _Phase.enRoute:
          return _DMockNav(pulse: pulse, arrived: false);
        case _Phase.arrived:
          return _DMockNav(pulse: pulse, arrived: true);
        case _Phase.inTrip:
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (_, __) => Positioned(
                      ...
                      child: Stack(
                        ...
                        children: [
                          Container(
                            width: 20 + 8 * pulse.value,
                            height: 20 + 8 * pulse.value,
                            decoration: BoxDecoration(
                              shape: BoxShape.circle,
